...
if __name__ == '__main__':
    ...
    Task_list = pd.read_excel('Task_list_Test.xlsx', sheet_name='Tasklist', usecols=[0,3,6,7,8], skiprows=0, nrows=6, dtype=object)
    ...
    graph.a_star_algorithm(0,32)
    #for i in Tasks:
        #graph.a_star_algorithm(Task_list.loc[i,'Start node'],Task_list.loc[i,'End node'])
